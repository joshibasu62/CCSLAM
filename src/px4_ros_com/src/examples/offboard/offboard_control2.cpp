...
public:
        ...
        use_sim_time_(false)
    {
        ...
        local_pos_subscriber_ = this->create_subscription<px4_msgs::msg::VehicleLocalPosition>(
            "/px4_1/fmu/out/vehicle_local_position", rclcpp::QoS(10).best_effort(), std::bind(&OffboardControl::local_pos_callback, this, std::placeholders::_1));

        status_subscriber_ = this->create_subscription<px4_msgs::msg::VehicleStatus>(
            "/px4_1/fmu/out/vehicle_status_v1", rclcpp::QoS(10).best_effort(), std::bind(&OffboardControl::vehicle_status_callback, this, std::placeholders::_1));

        ack_subscriber_ = this->create_subscription<px4_msgs::msg::VehicleCommandAck>(
            "/px4_1/fmu/out/vehicle_command_ack", rclcpp::QoS(10).best_effort(), std::bind(&OffboardControl::vehicle_cmd_ack_callback, this, std::placeholders::_1));
