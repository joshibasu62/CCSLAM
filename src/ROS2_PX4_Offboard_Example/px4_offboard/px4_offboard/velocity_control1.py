...
class OffboardControl(Node):
    ...
    def __init__(self):
        ...
        # UPDATED: Added _1 suffix to distinguish from Drone 0
        self.offboard_velocity_sub = self.create_subscription(
            Twist,
            '/offboard_velocity_cmd_1',
        ...
        #Create publishers
        # UPDATED: Added /px4_1 prefix to all
    ...
    def publish_vehicle_command(self, command, param1=0.0, param2=0.0, param7=0.0):
        ...
        # UPDATED: target_system is usually 2 for the second drone (px4_1)
        msg.target_system = 2  
    ...
    def offboard_velocity_callback(self, msg):
        ...
        # A conversion for angular z is done in the attitude_callback function
        self.yaw = msg.angular.z

    #receives current trajectory values from drone
