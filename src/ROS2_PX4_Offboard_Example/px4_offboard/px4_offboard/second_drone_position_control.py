...
class PositionControl(Node):
    ...
    def __init__(self):
        ...
        self.waypoints = [
            {"x": 0.0, "y": 0.0, "z": -1.0, "yaw": 0.0, "desc": "Takeoff to 2m"},      # Takeoff
            {"x": 0.0, "y": 0.0, "z": -1.0, "yaw": 0.785, "desc": "Forward 2m"},         # Forward
            {"x": 0.0, "y": -0.2, "z": -1.0, "yaw": 1.57, "desc": "Right 2m"},          # Right 1
            {"x": 0.0, "y": 0.0, "z": -1.0, "yaw": 2.356, "desc": "Right 2m"},          # Right 2
            {"x": 0.0, "y": 0.0, "z": -1.0, "yaw": 3.14159, "desc": "Right 2m"},          # Right 3
    ...
    def set_parameter(self, param_name: str, value: float, param_type: int = 9):
        """
        param_type:
            6 = INT32
            9 = FLOAT
        ...
        cmd_msg.command = VehicleCommand.VEHICLE_CMD_DO_SET_PARAMETER

        cmd_msg.param1 = value          # parameter value
        cmd_msg.param2 = float(param_type)  # parameter type

        # VERY IMPORTANT: param_id must be bytes (max 16 chars)
        cmd_msg.param_id = param_name.encode('utf-8')
