...
def generate_launch_description():
    ...
    def get_vslam_params(drone_namespace):
        return {
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                'camera_namespace': drone_ns,  # Pushes Realsense topics into the drone namespace
            ...
            actions=[
                Node(
                    ...
                    remappings=[
                        ...
                        ('rgb/camera_info', f'/{drone_ns}/camera/color/camera_info'),
